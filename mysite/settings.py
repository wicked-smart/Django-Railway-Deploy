...
ALLOWED_HOSTS = ["django-railway-deploy-production.up.railway.app", "localhost"]
...
#Trusted Origin issue
CSRF_TRUSTED_ORIGINS = ['https://django-railway-deploy-production.up.railway.app']